##  program name:
##  "pseudo_random_33_bit_simple.py"
##  language: Python 3
...
##  33 bit register (bits numbered
##  0 through 32) with tap points
##  at 0 and 3 with the
...
##  integers from 1 through 8589934591.
##  Zero never occurs. Each integer
##  occurs once and only once in
##  the sequence. After 8589934591
...
def fnc_next_random_binary_33_bit_string(str_seed):

    ##  This function accepts as an argument a 33 character string of zeros
    ...
    str_result = str_seed[1:33] + str_x  ##  "Shift" parity bit into the right
...
def fnc_main_body():
    ...
    ##  This string represents the 33 bit
    ##    binary image of the initial seed:

    str_seed = "000000000000000000000000000000001"
    ...
    while str_input == "":  ##  Enter the loop. As long as the user keeps
        ...
        str_new = fnc_next_random_binary_33_bit_string(str_seed)
...
def fnc_display_greeting_to_user():
    ...
    print("using a 33 character string of zeros and ones")
    print("to represent the integer as binary.")
    print('The initial seed is "000000000000000000000000000000001"')
    print("--i.e.-- 1.")
    print()
    print("Using 33 bit binary integers the LFSR method")
    print("can generate all the integers from 1 through 8589934591")
